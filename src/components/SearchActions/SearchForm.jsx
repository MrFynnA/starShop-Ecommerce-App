...
return <span className={`${classes['search-input']} max-md:h-full max-md:!rounded-lg`}><SearchIcon/><input className='max-md:!h-8' {...props.inputItems} onChange={onGetSearchTerm}/></span>
}
